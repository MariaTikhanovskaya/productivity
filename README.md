...
1. In Supabase SQL Editor, run [supabase.sql](/Users/maria.tikhanovskaya/productivity/supabase.sql).
2. In Supabase, copy your project URL and anon key.
3. Put them in [config.js](/Users/maria.tikhanovskaya/productivity/config.js).
4. In Supabase Auth URL settings, set your Site URL to your GitHub Pages URL.
5. Add that same GitHub Pages URL as a redirect URL for magic-link sign-in.
6. Publish the static files to GitHub Pages.
